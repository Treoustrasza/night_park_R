...
function narrativeDay5() {
  ...
  h += line('npc-colleague', '下班路上，顺路的同事在地铁上打了个哈欠：“这周熬过来了，周五晚上去楼下那家精酿店喝两杯？”');
...
function narrativeDay30() {
  ...
  h += line('npc-self', '你轻声附和。Mentor没再说话，对你疲惫地笑了笑，拿起笔记本和保温杯出去了。注视着其他参会同事挨个离开，你不禁开始胡思乱想，下次大部门例会的时候，哪些人会消失呢。');
  return h;
}
...
function narrativeDay60() {
  ...
  h += line('npc-narrator', 'Mentor沉默了片刻，把茶叶拨了拨，没再追问。“咱们小组的业绩不太好啊……你最近也在外面看看吧，我听到了一些不太好的风声，但具体的我不能说。”他发出轻飘飘的叹气声。');
  return h;
}
...
function narrativeHighDepWeekend() {
  ...
  h += line('npc-narrator', '你不禁开始怀念起戴上眼镜后的那种流畅和轻松。大脑里充满了华丽的构想，只要戴上那个就做得出来。');
  return h;
}
...
const WEEKEND_FLAVORS = [
  () => line('npc-narrator', '今天不用上班，难得奢侈地睡到九点多。一道阳光从密集的高楼之间穿过，暖烘烘地打在你的脸上。你醒了。盯着天花板发了一会儿呆，思绪清醒的第一件事却是想起还有个需求文档没看完。'),
...
const WEEKDAY_FLAVORS = [
  () => line('npc-narrator', '又是普通的一天。领导的办公室里传来咖啡机打磨豆子的响声，你知道他也早早地来上班了。打卡闸机旁边贴着喜庆的新年海报，已经有点褪色了但还没揭掉。真不知道行政最近在干什么，你想。'),

  () => line('npc-colleague', '同事把一份参考图甩过来：“这个风格你看行不行，领导说他要这个感觉，但我觉得他说的感觉他自己也不知道是啥。”')
    + line('npc-self', '你接过来看了看，也没太看懂领导的意思，但感到不是可以拒绝的氛围，还是说了句“我试试，不行再改吧。”'),
  ...
  () => line('npc-colleague', '同事拿着手机，凑过来小声说：“听说这季度公司营收再差的话，年终奖要发不出来了，你觉得真的假的？”')
    + line('npc-self', '你：“……不知道。”')
    + line('npc-colleague', '他：“我也不知道，但我感觉是真的……我打算出去看看机会了。”'),

  () => line('npc-narrator', '今天的todo比想象的多，ddl比想象的近。你已经学会习惯这种事了，但还是难免会觉得烦。'),

  () => line('npc-colleague', '同事笑着凑过来，殷勤地递上一罐冰可乐。你本能地从那个过分灿烂的笑容里嗅到了危机。')
    + line('npc-colleague', '“能帮我做一下这个吗？不急。”')
    + line('npc-self', '“不急是什么时候要？”')
    + line('npc-colleague', '“今天下班之前可以吗？领导急着要。”他嘿嘿笑，虽然是疑问句，但并没有真的要和你商量的意思'),

  () => line('npc-narrator', '今天领导临时把旁边工位的同事叫去oneone，和了大概二十分钟。出来之后那个同事面色如常，什么都没说。你也没问，这是职场不成文的礼仪和默契。'),
